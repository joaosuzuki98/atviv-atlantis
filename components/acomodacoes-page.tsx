...
export default function AcomodacoesPage({ acomodacoes, setAcomodacoes }: AcomodacoesPageProps) {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		const acomodacaoData: Acomodacao = {
			id: editingAcomodacao ? editingAcomodacao.id : Date.now().toString(),
			...formData,
		}

		if (editingAcomodacao) {
			setAcomodacoes(acomodacoes.map((a) => (a.id === editingAcomodacao.id ? acomodacaoData : a)))
		} else {
			setAcomodacoes([...acomodacoes, acomodacaoData])
		}
